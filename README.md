...
python reason_case.py --idx 123 --models_dir models_blend_cv --X_tab X_tab.npy --X_scores X_scores.npy --X_pathway X_pathway.npy --med_flags med_flags_24h.npy --ontology causal_ontology.py --rules causal_rules.py --graph causal_graph.py --out_dir reports
